...
import {
    ...
    GET_USERS_REQUEST, GET_USERS_SUCCESS, GET_USERS_FAILURE, UPDATE_USER_REQUEST, UPDATE_USER_FAILURE, UPDATE_USER_SUCCESS, GET_USER_SUCCESS, GET_USER_REQUEST, GET_USER_FAILURE, DELETE_USER_REQUEST, DELETE_USER_SUCCESS, DELETE_USER_FAILURE
} from '../actions/types'
...
export const deleteUser = (id) => async dispatch => {
    ...
    if (res.status === 204) {
        ...
        if (res.status === 500) {
            dispatch({ type: DELETE_USER_FAILURE, payload: { error: res.data.e } })
        }
    }
}
